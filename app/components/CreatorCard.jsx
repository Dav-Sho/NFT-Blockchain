...
const CreatorCard = ({creatorName, creatorImage, createEths, rank}) => {
  return (
    <div className='min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black-3 border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4'>
        ...
        <div className="my-2 flex justify-center">
            <div className="relative w-20 h-20 minlg:w-28 minlg:h-28">
                <Image src={creatorImage} layout='fill' alt='creator' objectFit='cover' className='rounded-full'/>
        ...
        <div className="mt-3 minlg:mt-7 text-center flexCenter flex-col">
            ...
            <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base mt-1">{createEths.toFixed(2)} <span className='font-normal'>ETH</span></p>
        </div>
    </div>
  )
}
